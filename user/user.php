              ...
              <div class="row">
                <div class="col-lg-3">
                  <div class="bg-white rounded-3 p-0,5 shadow card align-items-center d-flex">
                    <h2 style="color: yellow">29.5M</h2>
                    <div>
                      <h4>Publikasi</h4>
                    </div>
                  </div>
                ...
                <div class="col-12 col-md-3 mb-3">
                  ...
                  <div class="d-flex">
                    <ul class="nav flex-colum me-5">
                      <li class="nav-item mb-2"><a href="" class="nav-link p-0 text-muted">Buku Terbaru</a>
                      </li>
                ...
                <div class="col-12 col-md-3 mb-3">
                  ...
                  <ul class="nav fllex-colum">
                    <li class="nav-item mb-2"><a href=""
                      class="nav-link p-0 text-muted">info@perpus.sch.id</a></li>
                    <li class="nav-item mb-2"><a href=""
                      class="nav-link p-0 text-muted">0831-6203-7362</a></li>
                  </ul>
                </div>
                <div class="col-12 col-md-3 mb-3">
