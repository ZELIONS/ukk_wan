                ...
                <form method="post" action="?id=<?php echo $id ?>">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-7"> <!-- Mengubah ukuran kolom menjadi 6 -->
                            <input type="date" class="form-control" name="tanggal_peminjaman" max="<?php echo date('Y-m-d', strtotime('0 days')); ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-4 ms-4">Tanggal Pengembalian MAX (7Hari)</div>
                        <div class="col-md-7"> <!-- Mengubah ukuran kolom menjadi 6 -->
                            <input type="date" class="form-control" name="tanggal_pengembalian" max="<?php echo date('Y-m-d', strtotime('+7 days')); ?>">
                        </div>
                    </div>
                    <div class="row mb-3">
